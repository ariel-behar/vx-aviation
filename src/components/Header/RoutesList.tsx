                    ...
                    if (index !== 0 && title !== 'Contact') {
                        return (
                            <NavLink
                                ...
                                key={uniqid()}
                            >
                                <li style={{ textShadow: "3px 3px 2px rgba(15,15,15,0.8)" }} className="p-1 font-normal text-lg sm:text-base lg:text-lg" onClick={(screenSize === "xs" || screenSize === "sm") ? () => toggleNavHandler(true) : undefined}>
                                    {title}
                                </li>
                            </NavLink >
                        )
                        ...
                        return (
                            <li key={uniqid()} style={{ textShadow: "3px 3px 2px rgba(15,15,15,0.8)" }} className="p-1 font-normal -normal text-lg sm:text-base lg:text-lg text-primary" >
                                <HashLink className='cursor-pointer' to={path} scroll={el => scrollWithOffset(el)} onClick={(screenSize === "xs" || screenSize === "sm") ? () => toggleNavHandler(true) : undefined}>
                                    {title}
                                </HashLink>
                            </li>
                        )
