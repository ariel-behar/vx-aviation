...
function AirplanesForSaleView() {
	return (
		<>
			<HelmetSEO title='AIRPLANES FOR SALE' description='Find Your Wings: Discover our selection of quality airplanes for sale at VX Aviation. From single-engine to commercial aircraft, explore your options and take flight with confidence.' />
